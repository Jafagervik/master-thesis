...
\shorttitle{Enhancing Efficiency in DAS Processing and Anomaly Detection}
...
% Define a custom caption style with reduced width
...
\noindent {Designing Scalable Programs for Enhanced Efficiency in \acrshort{das} Data Processing and Analysis} \\
